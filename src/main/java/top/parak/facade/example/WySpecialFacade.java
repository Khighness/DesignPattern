package top.parak.facade.example;
 ...
 * <p> Package: top.parak.facade.example </p>
 * <p> FileName: WySpecialFacade <p>
 * <p> Description: 婺源特产 <p>
...
public class WySpecialFacade {
    public static void main(String[] args) {
        JFrame f=new JFrame ("婺源特产");
...
class WySpecialty extends JPanel implements TreeSelectionListener , Serializable {
...
class Specialty1 extends ImageIcon {
    private static final long serialVersionUID = 1L;
    public Specialty1() {
        super("img/WyImage/Specialty11.jpg");
    }
}
...
class Specialty2 extends ImageIcon {
    private static final long serialVersionUID = 1L;
    public Specialty2() {
        super("img/WyImage/Specialty12.jpg");
    }
}
...
class Specialty3 extends ImageIcon {
    private static final long serialVersionUID = 1L;
    public Specialty3() {
        super("img/WyImage/Specialty13.jpg");
    }
}
...
class Specialty4 extends ImageIcon {
    private static final long serialVersionUID = 1L;
    public Specialty4() {
        super("img/WyImage/Specialty14.jpg");
    }
}
...
class Specialty5 extends ImageIcon {
    private static final long serialVersionUID = 1L;
    public Specialty5() {
        super("img/WyImage/Specialty21.jpg");
    }
}
...
class Specialty6 extends ImageIcon {
    private static final long serialVersionUID = 1L;
    public Specialty6() {
        super("img/WyImage/Specialty22.jpg");
    }
}
...
class Specialty7 extends ImageIcon {
    private static final long serialVersionUID = 1L;
    public Specialty7() {
        super("img/WyImage/Specialty23.jpg");
    }
}
...
class Specialty8 extends ImageIcon {
    private static final long serialVersionUID = 1L;
    public Specialty8() {
        super("img/WyImage/Specialty24.jpg");
    }
}
